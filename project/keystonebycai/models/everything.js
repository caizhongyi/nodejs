...
Everything.add(
   'Simple Fields', {
	...
	country: { type: Types.Country, initial: true },
	...
	image: { type: Types.Image , dest : 'public/upload/test-image/' },
	images: { type: Types.Images  , dest : 'public/upload/test-image/'},
	localfile: { type: Types.LocalFile , dest : 'public/upload/test-file/'},
	localfiles: { type: Types.LocalFiles , dest : 'public/upload/test-file/'},
	videos: { type: Types.Videos , dest : 'public/upload/test-videos/'},
